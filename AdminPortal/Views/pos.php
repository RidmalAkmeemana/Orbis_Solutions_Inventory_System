												...
												<div class="card">
													<div class="card-body">	
														...
														<div class="row">
															...
															<div class="col-md-2">
																<input style="width: 100%; display:;" type="number" name="Id[]" class="form-control" min="1" readonly required>
															...
															<div class="col-md-2">
																<div class="input-group">
																	<div class="input-group-prepend">
																		...
																		<input style="width: 100%; display:;" type="text" name="Retail_Price" class="form-control text-right" readonly required>
