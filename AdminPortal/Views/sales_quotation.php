...
<head>
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-7 col-auto">
								<h3 class="page-title">Sales Quotation</h3>
								<ul class="breadcrumb">
    ...
    $(document).ready(function () {
        // Make an AJAX request to getAllQuotationData.php
		$.ajax({
			type: 'POST',
			url: '../../API/Admin/getAllQuotationData.php',
			dataType: 'json',
			success: function (data) {
				if (data.length > 0) {
					...
					$.each(data, function (index, row) {
						...
						const quoteBy = row.First_Name + ' ' + row.Last_Name;
						...
						table.row.add([
							...
							row.Quotation_Date,
							quoteBy,
							'<div class="actions"><a class="btn btn-sm bg-success-light" href="view_quotation.php?Quotation_No=' + row.Quotation_Id + '"><i class="fe fe-eye"></i> View </a></div>'
						]);
					});
