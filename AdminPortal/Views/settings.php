														...
														<div class="form-group row">
															<div class="col-md-4">
																...
																<div class="service-charge">
																	...
																	<input type="number" class="form-control mt-2" required name="serviceCharge" id="serviceCharge">
																</div>
															</div>
															...
															<div class="col-md-4">
																...
																<div class="tax-charge">
																	...
																	<input type="number" class="form-control mt-2" required name="taxCharge" id="taxCharge">
																</div>
															</div>
															...
															<div class="col-md-4">
																...
																<div class="vat-charge">
																	...
																	<input type="number" class="form-control mt-2" required name="vatCharge" id="vatCharge">
																</div>
															</div>
														</div>
